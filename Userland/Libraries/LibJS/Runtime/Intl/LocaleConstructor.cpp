...
ThrowCompletionOr<NonnullGCPtr<Object>> LocaleConstructor::construct(FunctionObject& new_target)
{
    ...
    // 19. Let fw be ? GetOption(options, "firstDayOfWeek", "string", undefined, undefined).
